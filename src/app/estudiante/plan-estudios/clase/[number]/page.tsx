...
import { ArrowLeft, CheckCircle2, XCircle, FileText, Download, BookOpen, ClipboardList, Calendar, Clock } from "lucide-react"
...
export default async function ClassDetailPage({ params }: PageProps) {
  ...
  // Get materials, attendance and assignments
  const [materials, attendanceRecords, assignments] = await Promise.all([
