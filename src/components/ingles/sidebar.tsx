...
const navItems = [
  { href: "/ingles", label: "Inicio", icon: Home },
  { href: "/ingles/lecciones", label: "Lecciones", icon: BookOpen },
  { href: "/ingles/mi-progreso", label: "Mi Progreso", icon: BarChart3 },
  { href: "/ingles/certificados", label: "Certificados", icon: Award },
  { href: "/ingles/suscripcion", label: "Suscripción", icon: CreditCard },
  { href: "/ingles/soporte", label: "Soporte", icon: HeadphonesIcon },
]
  ...
  return (
    <div className="flex h-full flex-col bg-card border-r">
      ...
      <div className="flex h-16 items-center border-b px-6">
        <Link href="/ingles" className="flex items-center gap-2">
...
export function EnglishSidebar({ user }: { user: CurrentUser | null }) {
